...
public final class GsonUtilsHelper {
    ...
    public static synchronized GsonDecorator createGsonDecorator() {
        return createGsonDecorator(gsonBuilder);
    }

    public static synchronized GsonDecorator createPrettyPrintGsonDecorator() {
        return createPrettyPrintGsonDecorator(gsonBuilder);
    }
