...
import static ru.olegcherednik.gson.utils.PrettyPrintUtils.UNIX_LINE_SEPARATOR;
import static ru.olegcherednik.gson.utils.PrettyPrintUtils.withUnixLineSeparator;
...
public class GsonUtilsHelperTest {
    ...
    public void shouldUseNewBuilderWhenSetNotNullBuilderToGsonHelper() {
        ...
        GsonUtilsHelper.setGsonBuilder(new GsonUtilsBuilder().zonedDateTimeFormatter(zone -> ZoneId.of("Asia/Singapore"), ISO_ZONED_DATE_TIME));
