...
public class ReadBroadbandTest {
    ...
    private static DataModel.LineDiagnostics getLineDiagnostics() {
        ...
        lineDiagnostics.getLineDiagnostics().put("C4000LG2020253739", getLineDiagnostic());
    ...
    public static class DataModel {
        ...
        @Setter
        @EqualsAndHashCode
        @JsonAdapter(LineDiagnosticsDeserializer.class)
        ...
        public static class Ap {
            ...
            @SerializedName("broadbanddsthroughput")
            private BroadbandDsThroughput broadbandDsThroughput;
            @SerializedName("broadbandusthroughput")
        ...
        public static class BroadbandThroughput {
            ...
            @SerializedName("speedTestTrafficMB")
    ...
    private static final class LineDiagnosticsDeserializer implements JsonDeserializer<DataModel.LineDiagnostics> {
        @Override
        public DataModel.LineDiagnostics deserialize(JsonElement json,
                                                     Type typeOfT,
            ...
            for (Map.Entry<String, JsonElement> entry : jsonObject.entrySet()) {
                ...
                DataModel.LineDiagnostic lineDiagnostic = context.deserialize(entry.getValue(),
                                                                              DataModel.LineDiagnostic.class);
                lineDiagnostics.getLineDiagnostics().put(key, lineDiagnostic);
            }
