...
import ru.olegcherednik.json.gson.utils.LocalZoneId;
...
public class ZonedDateTimeTest {
    ...
    public void shouldRetrieveDeserializedZonedDateTimeMapWhenReadJsonAsMap() {
        JsonSettings settings = JsonSettings.builder()
                                            .offsetDateTimeFormatter(DateTimeFormatter.ISO_DATE_TIME)
                                            .build();
        ...
        Map<String, ZonedDateTime> actual = Json.createReader(settings)
                                                .readMap(json, String.class, ZonedDateTime.class);
